...
ARCH		?=arm64
CROSS_COMPILE	?=/home/miko/Documents/playground/linaro_-_7.5/bin/aarch64-linux-gnu-
...
#		   -Werror
# Not using -Werror flag because some old shitty driver and shitty scamsung code
